<template>
  <ul class="list text--white bg--black">
    <p v-if="isSearching" class="list--message">Consulting Professor Oak's database</p>
    <p v-else-if="hasSearchError" class="list--message">You haven't caught this Pokémon yet.</p>
