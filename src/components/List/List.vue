...
<template>
    ...
    <ul class="list text--white bg--black-blue">
      <p v-if="isSearching" class="list--message">Procurando o Pokémon...</p>
      <p v-else-if="hasSearchError" class="list--message">Não conseguimos encontrar este Pokémon.</p>
